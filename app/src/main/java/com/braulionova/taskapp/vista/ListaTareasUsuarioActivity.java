...
public class ListaTareasUsuarioActivity extends AppCompatActivity {
    ...
    private static final String LOG_TAG = "ListaTareasUsuario";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            tareas = tareaRepositorio.buscarCreadaPor(usuario);
            ...
            //adapter
            tareasListView.setAdapter(new TareaUsuarioListAdapter(this, tareas));
            //list view
            tareasListView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l)
                {
                    try {
                        ...
                        //intent
                        Intent listaDeTareasIntent = new Intent(ListaTareasUsuarioActivity.this, DetalleTareaActivity.class);
